import {
  ...
  HelpCircle, LayoutDashboard, ListTree, Network, ScrollText, ServerCog, Settings, TicketCheck,
} from 'lucide-react'
...
export const navigation: { id: ModuleId; label: string; section: string; icon: typeof Activity }[] = [
  ...
  { id:'help', label:'Central de ajuda', section:'Plataforma', icon:HelpCircle },
